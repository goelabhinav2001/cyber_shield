...
c_cols=35
margin = 100
screen_width = tile_size * c_cols
screen_height = (tile_size * r_cols) + margin
...
for tile in range(0,r_cols):
	world_data[tile][0]=1
	world_data[tile][c_cols-1]=1

for tile in range(0,c_cols):
	world_data[0][tile]=1
	world_data[r_cols-1][tile]=1
